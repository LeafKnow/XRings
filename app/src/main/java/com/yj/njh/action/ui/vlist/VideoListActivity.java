...
//                videoListPresenter.getCombSearch(queryConditions.getAreaId(), queryConditions.getGenreId(), queryConditions.getGroupId(), queryConditions.getChargeMethod(), queryConditions.getVipLevel(), queryConditions.getYear(), queryConditions.getType(), page + "", AppConstant.PAGESIZE);
                getvideoListInfo(classDataModel.getClassX().get(position).getId());
            }
        });
...
//                        videoListPresenter.getCombSearch(queryConditions.getAreaId(), queryConditions.getGenreId(), queryConditions.getGroupId(), queryConditions.getChargeMethod(), queryConditions.getVipLevel(), queryConditions.getYear(), queryConditions.getType(), page + "", AppConstant.PAGESIZE);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(VideoListActivity.this,MovieDetailsActivity.class).putExtras(bundle));
//                }
...
//        videoListPresenter.getCombQueryConditions(videoType);
     ...
     */
    public void showListView(List<ClassDataModel.ClassBean> conditionsArrayList) {
    ...
    protected void updateView(Store.StoreChangeEvent event) {
        ...
        if ("getvideoTitleInfo".equals(event.url)){
             classDataModel= (ClassDataModel) event.data;
            showListView(classDataModel.getClassX());
            getvideoListInfo(classDataModel.getClassX().get(0).getId());
