...
//    private MovieDetailsPresenter movieDetailsActivity = new MovieDetailsPresenter(this);
    ...
    private VoideInfoListBean.ListBean listBean; //电视剧数据数据
    String videoType = "1";
...
//            movieDetailsActivity.initSerialData(videoId,userId);
//        }
        VoideInfoListBean.ListBean listBean= (VoideInfoListBean.ListBean) getIntent().getSerializableExtra("videoInfo");
...
//        }
     ...
     * @param
     */
    public void initViewSerialDate(VoideInfoListBean.ListBean listBean) {
...
//            ((TextView)findViewById(R.id.movie_details_act)).setText("主演：" + zhuyan);
//        }
        ((TextView)findViewById(R.id.movie_details_descri)).setText(Html.fromHtml(listBean.getDes()));
        ImageView imageView = (ImageView)findViewById(R.id.movie_details_img_id);
